...
/* ── MCP ───────────────────────────────────────────────────────── */
  ...
  'gate.hidePassword': 'Ẩn mật khẩu',
  'gate.showPassword': 'Hiện mật khẩu',
  'gate.sub.reset': 'Nhập mã trong email và chọn mật khẩu mới.',
  'gate.sub.forgot': 'Nhập email của bạn, chúng tôi sẽ gửi mã đặt lại.',
  'gate.sub.first': 'Tạo tài khoản đầu tiên — tài khoản này sẽ là quản trị viên.',
  'gate.sub.signup': 'Tạo tài khoản của bạn.',
  'gate.sub.signin': 'Đăng nhập để tiếp tục.',
  'gate.submit.reset': 'Đặt mật khẩu mới',
  'gate.submit.forgot': 'Gửi mã đặt lại',
  'gate.submit.signup': 'Tạo tài khoản',
  'gate.switch.toSignin': 'Đã có tài khoản? Đăng nhập',
  'gate.switch.toSignup': 'Chưa có tài khoản? Đăng ký',
  'gate.note.firstAccount': 'Chưa ai đăng ký trên bản triển khai này. Hãy tạo tài khoản đầu tiên.',
  'gate.note.resetSent': 'Nếu địa chỉ đó có tài khoản, mã đặt lại đang được gửi. Nhập mã bên dưới.',
  'gate.note.passwordUpdated': 'Đã cập nhật mật khẩu. Đăng nhập bằng mật khẩu mới.',
  'gate.note.noMail': 'Chưa cấu hình dịch vụ email — mã xác nhận nằm trong log của máy chủ.',
  'gate.error.generic': 'Không thực hiện được.',
  'suggest.workspace': 'Cho tôi xem có gì trong workspace và tóm tắt dự án.',
  'suggest.library': 'Tìm trên web xem thư viện này gần đây có gì thay đổi.',
  'suggest.todos': 'Tìm mọi TODO trong mã nguồn và nhóm theo tệp.',
  'suggest.tests': 'Chạy bộ test và giải thích những chỗ hỏng.',
  'chat.openFailed': 'Không mở được cuộc trò chuyện đó.',
  'nav.noConversations': 'Chưa có cuộc trò chuyện nào',
  'chat.deleted': 'Đã xoá cuộc trò chuyện.',
  'chat.answersFrom': 'Trả lời từ',
  'chat.answersFirstFrom': 'Trả lời trước hết từ',
  'project.namePrompt': 'Đặt tên cho nó — một môn học, một khách hàng, một bài tập.',
  'clipboard.failed': 'Không truy cập được clipboard — hãy bôi đen đoạn văn bản và bấm Ctrl+C.',
  'chat.stopBeforeEdit': 'Dừng lượt chạy trước đã — sửa tin nhắn sẽ tua lại cuộc trò chuyện.',
  'chat.stillSaving': 'Tin nhắn này còn đang được lưu. Thử lại sau một lát.',
  'composer.empty': 'Tin nhắn không được để trống.',
  'composer.uploading': 'Đang tải lên — chờ một lát.',
  'worker.fullDisk': 'Công cụ tệp: toàn bộ ổ đĩa',
  'worker.desktopOff': 'Điều khiển desktop: tắt',
  'worker.noTools': 'Công cụ tệp và shell bị ẩn khỏi trợ lý cho tới khi có máy kết nối.',
  'settings.effort': 'Mức độ suy luận',
  'action.reallyRemove': 'Xoá thật chứ?',
  'account.nameUpdated': 'Đã cập nhật tên.',
  'account.totpOff': 'Đã tắt xác thực hai bước.',
  'account.passwordUpdatedAll': 'Đã cập nhật mật khẩu. Mọi thiết bị khác đã bị đăng xuất.',
  'account.passwordUpdated': 'Đã cập nhật mật khẩu.',
  'admin.tokenLimit': 'Hạn mức token hằng tháng khi dùng khoá API dùng chung. 0 là không giới hạn.',
  'models.verifying': 'Đang xác minh với OpenRouter…',
  'devices.calling': 'Đang gọi từng máy…',
  'devices.add': 'Thêm máy tính',
  'devices.thisOne': 'Máy này',
  'devices.yours': 'Máy tính của bạn — thêm máy khác, hoặc đổi máy đang dùng',
  'devices.none': 'Chưa có máy nào kết nối. Bấm để thêm.',
  'devices.waiting': 'Đang chờ được thêm.',
  'devices.willReport': 'Máy sẽ báo nơi nó đang làm việc ngay khi kết nối.',
  'devices.moved': 'Đã lưu. Máy đó sẽ chuyển trong khoảng mười lăm giây.',
  'devices.switched': 'Đã đổi máy.',
  'devices.reallyUnpair': 'Huỷ ghép nối thật chứ?',
  'news.contextWindow': 'Cửa sổ ngữ cảnh',
  'news.yourKey': 'Khoá OpenRouter của bạn',
  'news.free': 'Cái này miễn phí — thử không mất gì.',
  'news.billed': 'Tính vào khoá OpenRouter của bạn theo mức giá ở trên.',
  'compact.turnOn': 'Bật tự động nén',
  'compact.turnOff': 'Tắt tự động nén',
  'compact.onHint': 'Tự động gấp các lượt cũ lại trước khi đầy cửa sổ.',
  'compact.offHint': 'Cuộc trò chuyện sẽ ngừng hoạt động khi cửa sổ đầy.',
  'compact.isOn': 'Tự động nén đang bật.',
  'compact.isOff': 'Tự động nén đang tắt. Trò chuyện dài sẽ chạm giới hạn cửa sổ.',
  'compact.now': 'Nén ngay',
  'compact.nowHint': 'Tóm tắt các lượt trước và tiếp tục với phần chỗ trống vừa giải phóng.',
  'compact.nothing': 'Chưa có gì để nén.',
  'compact.working': 'Đang gấp các lượt trước lại…',
  'action.expandMenu': 'Mở rộng menu',
  'file.docx': 'Tài liệu Word',
  'file.xlsx': 'Bảng tính Excel',
  'file.pptx': 'Bản trình chiếu PowerPoint',
  'file.csv': 'Dữ liệu bảng tính',
  'file.html': 'Trang web',
  'file.txt': 'Văn bản thuần',
  'session.expired': 'Phiên đăng nhập đã hết hạn.',
  'account.yourPassword': 'Mật khẩu của bạn',
  'account.enterCode': 'Nhập mã 6 số',
  'devices.revertedToOwn': 'Đã lưu. Máy sẽ quay lại thiết lập riêng của nó.',
  'pages.tasks.lede': 'Công việc chạy theo lịch, hoặc chạy khi bạn bấm. Mỗi lần chạy nằm trong một cuộc trò chuyện riêng, đọc lại lúc nào cũng được.',
};
